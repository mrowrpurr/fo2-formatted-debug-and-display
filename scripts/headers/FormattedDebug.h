...
// #define debug1(text, a1)                     debug(text + ": " + debug_array_str([a1]))
// #define debug2(text, a1, a2)                 debug(text + ": " + debug_array_str([a1, a2]))
// #define debug3(text, a1, a2, a3)             debug(text + ": " + debug_array_str([a1, a2, a3]))
// #define debug4(text, a1, a2, a3, a4)         debug(text + ": " + debug_array_str([a1, a2, a3, a4]))
// #define debug5(text, a1, a2, a3, a4, a5)     debug(text + ": " + debug_array_str([a1, a2, a3, a4, a5]))
// #define debug6(text, a1, a2, a3, a4, a5, a6) debug(text + ": " + debug_array_str([a1, a2, a3, a4, a5, a6]))
